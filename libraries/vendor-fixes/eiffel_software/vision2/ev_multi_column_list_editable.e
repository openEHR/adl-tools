...
feature -- Initialization
	...
	enable_editing (a_window: EV_WINDOW)
		...
		do
			...
			has_relative_window: attached relative_window
			change_widgets_not_void: attached change_widgets
			editable_columns_not_void: attached editable_columns
		end
...
feature -- Status report
	...
	column_editable (i: INTEGER): BOOLEAN
		...
		do
			Result := all_columns_editable or else editable_columns.has (i)
		end
