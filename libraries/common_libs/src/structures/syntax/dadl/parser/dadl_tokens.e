...
feature -- Token codes
	...
	SYM_QUERY_FUNC: INTEGER = 282
	SYM_TRUE: INTEGER = 283
	SYM_FALSE: INTEGER = 284
	SYM_LT: INTEGER = 285
	SYM_GT: INTEGER = 286
	SYM_LE: INTEGER = 287
	SYM_GE: INTEGER = 288
	ERR_CHARACTER: INTEGER = 289
	ERR_STRING: INTEGER = 290
	ERR_CADL_MISPLACED: INTEGER = 291
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER = 292
	ERR_V_LOCAL_TERM_CODE_REF: INTEGER = 293
