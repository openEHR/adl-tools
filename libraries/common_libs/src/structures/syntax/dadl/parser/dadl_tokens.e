...
feature -- Token codes
	...
	V_ISO8601_EXTENDED_DATE: INTEGER is 263
	V_ISO8601_EXTENDED_TIME: INTEGER is 264
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER is 265
	V_ISO8601_DURATION: INTEGER is 266
	V_CADL_BLOCK: INTEGER is 267
	V_LOCAL_CODE: INTEGER is 268
	V_QUALIFIED_TERM_CODE_REF: INTEGER is 269
	V_LOCAL_TERM_CODE_REF: INTEGER is 270
	V_URI: INTEGER is 271
	V_CHARACTER: INTEGER is 272
	SYM_START_DBLOCK: INTEGER is 273
	SYM_END_DBLOCK: INTEGER is 274
	SYM_EQ: INTEGER is 275
	SYM_ELLIPSIS: INTEGER is 276
	SYM_LIST_CONTINUE: INTEGER is 277
	SYM_INFINITY: INTEGER is 278
	SYM_INTERVAL_DELIM: INTEGER is 279
	SYM_DT_UNKNOWN: INTEGER is 280
	SYM_QUERY_FUNC: INTEGER is 281
	SYM_TRUE: INTEGER is 282
	SYM_FALSE: INTEGER is 283
	SYM_LT: INTEGER is 284
	SYM_GT: INTEGER is 285
