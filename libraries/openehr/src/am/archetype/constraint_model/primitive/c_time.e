...
inherit
	...
	DATE_TIME_ROUTINES
		export
			{NONE} all;
			{ANY} is_valid_iso8601_time_constraint_pattern, is_valid_iso8601_time_string, 
...
feature -- Initialisation
	...
	make_string_interval(a_lower, an_upper: STRING) is
		...
		require
			...
			lower_exists: a_lower /= void implies is_valid_iso8601_time_string(a_lower)
			upper_exists: an_upper /= void implies is_valid_iso8601_time_string(an_upper)
