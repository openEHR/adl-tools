...
inherit
	...
	DATE_TIME_ROUTINES
		export
			{NONE} all;
			{ANY} is_valid_iso8601_date_constraint_pattern, is_valid_iso8601_date_string, 
...
feature -- Initialisation
	...
	make_string_interval(a_lower, an_upper: STRING) is
		...
		require
			...
			lower_exists: a_lower /= void implies is_valid_iso8601_date_string(a_lower)
			upper_exists: an_upper /= void implies is_valid_iso8601_date_string(an_upper)
	...
	make_from_pattern(a_pattern: STRING) is
		...
		require
			a_pattern_valid: a_pattern /= Void and then is_valid_iso8601_date_constraint_pattern(a_pattern)
		do
			pattern := a_pattern
		ensure
