...
--	add_coded_term_definition (group, a_language: attached STRING; a_term: attached ARCHETYPE_TERM)
--			-- add a new term definition for language `a_language'
--		require
--			Group_valid: not group.is_empty
--		local
--			t_path: STRING
...
--				attr_node := dt_representation.attribute_node_at_path(t_path)
...
--	add_binding_terminology (a_terminology: attached STRING)
...
--	remove_binding_terminology (a_terminology: attached STRING)
