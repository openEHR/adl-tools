...
feature -- Status Report
	...
	has_path(a_path: STRING):BOOLEAN is
			-- True if a_path exists in this archetype. If asked on an archetype with is_flat = True, result
			-- indicates whether path exists anywhere in inheritance-flattened archetype. ; uses path map so as to pick up
			-- paths generated by internal references
		require
...
feature -- Modification
	...
	set_parent_archetype (an_archetype: ARCHETYPE) is
