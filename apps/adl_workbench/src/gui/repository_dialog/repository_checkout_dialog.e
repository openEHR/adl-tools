...
feature {NONE} -- Initialization
	...
	create_interface_objects
		...
		do
			...
			create ev_label_1
			ev_label_1.set_text (get_text ({ADL_MESSAGES_IDS}.ec_repository_checkout_branch_dialog_header_label))
			...
			-- ============ branches combo ============
			create evx_branch_combo.make (get_text ({ADL_MESSAGES_IDS}.ec_repository_checkout_branch_combo_label), get_text ({ADL_MESSAGES_IDS}.ec_repository_checkout_branch_combo_tooltip),
				agent :STRING do Result := branch_name end, branches, 0)
	...
	initialize
		do
			...
			set_title (get_text ({ADL_MESSAGES_IDS}.ec_repository_checkout_dialog_title))
