...
feature {NONE} -- Implementation
	...
	archetype_node_handler (ev_ti: EV_GRID_ROW; x,y, button: INTEGER)
		...
		local
			...
			an_mi: EV_MENU_ITEM
		do
			if button = {EV_POINTER_CONSTANTS}.right and attached {ARCH_LIB_ARCHETYPE_ITEM} ev_ti.data as aca then
				create menu
	...
	display_context_selected_archetype_in_active_tool (ev_ti: EV_GRID_ROW)
		do
			ev_ti.enable_select
			if attached {ARCH_LIB_ARCHETYPE_ITEM} ev_ti.data as aca then
