...
feature -- Access
	...
	select_archetype_agent, select_archetype_in_new_tool_agent: detachable PROCEDURE [ANY, TUPLE [ARCH_LIB_ARCHETYPE_ITEM]]

	edit_archetype_in_new_tool_agent: detachable PROCEDURE [ANY, TUPLE [ARCH_LIB_ARCHETYPE_ITEM]]

	archetype_has_editor_agent: detachable FUNCTION [ANY, TUPLE [ARCH_LIB_ARCHETYPE_ITEM], BOOLEAN]
