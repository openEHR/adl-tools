...
feature {NONE} -- Initialization
	...
	initialize
		...
		do
			...
			ev_vbox_3.set_padding (padding_width)
			ev_vbox_3.set_border_width (border_width)
			ev_vbox_3.disable_item_expand (ev_hbox_3)
			ev_vbox_3.disable_item_expand (ev_hbox_6)
			ev_hbox_4.set_minimum_height (23)
			ev_hbox_4.set_padding (padding_width)
			ev_hbox_4.set_border_width (border_width)
			...
			ev_hbox_5.set_padding (padding_width)
			ev_hbox_5.set_border_width (border_width)
			...
			ev_hbox_6.set_padding (padding_width)
			ev_hbox_6.set_border_width (border_width)
			...
			ev_vbox_4.set_padding (padding_width)
			ev_vbox_4.set_border_width (border_width)
			ev_vbox_4.disable_item_expand (ev_hbox_7)
			ev_vbox_4.disable_item_expand (ev_hbox_8)
			ev_hbox_7.set_minimum_height (25)
			ev_hbox_7.set_padding (padding_width)
			ev_hbox_7.set_border_width (border_width)
			...
			ev_hbox_8.set_padding (padding_width)
			ev_hbox_8.set_border_width (border_width)
			...
			ev_vbox_5.set_padding (border_width)
			ev_vbox_5.set_border_width (padding_width)
			...
			ev_hbox_9.set_padding (padding_width)
			ev_hbox_9.set_border_width (border_width)
			...
			ev_hbox_10.set_padding (padding_width)
			ev_hbox_10.set_border_width (border_width)
			...
			ev_hbox_11.set_padding (padding_width)
			ev_hbox_11.set_border_width (border_width)
			...
			ev_hbox_12.set_border_width (border_width)
