...
feature -- Access
	...
	select_archetype_agent, select_archetype_in_new_tool_agent, edit_archetype_in_new_tool_agent: detachable PROCEDURE [ANY, TUPLE [ARCH_CAT_ARCHETYPE_UI_STATE]]

	archetype_has_editor_agent: detachable FUNCTION [ANY, TUPLE [ARCH_CAT_ARCHETYPE_UI_STATE], BOOLEAN]
