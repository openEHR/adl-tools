...
<head>
	...
	<link rel="bookmark" href="http://www.openehr.org/downloads/ADLworkbench/gettingstarted" title="openEHR - ADL Workbench">
...
<div id="MainFrame">
	...
	<div id="MainArea">
		...
		<div id="TextArea">
			...
			<h2>Overview</h2>
			<p>The ADL Workbench is completely model-driven, and uses schema files expressed in a simple object model format to import reference model (RM) definitions. Multiple RMs can be imported during any one session, enabling comparison of models, classes and archetypes based on different models.</p>
			<p>The second key configuration required is to set up 'profiles' defining where archetypes and templates are to be found.</p>
			
			
			<h2>Download some archetypes</h2>
			<p>For first-time use, you will be asked to provide paths to archetypes. It helps to have already downloaded some archetypes! See <a href="obtainingarchetypes">here</a> how to do this.</p>
			
			
			<h2>Basic Configuration</h2>
			
			<h3>Setting RM Schemas</h3>
			<p>To import RM definition schemas, a directory has to be specified, and the particular models required selected. At installation, the AWB is normally set up to point to a set of schemas that is the latest copy at the time of distribution, of the schema files found in the knowledge2 SVN repository. You may want to check which Reference Model schemas are enabled initially. Choose RM Schemas &gt; Configure Schemas to do this. The dialog looks as follows.</p>
