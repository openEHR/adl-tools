...
feature -- Factory
	...
	create_arch_cat_archetype_make_new_archetype (an_id: ARCHETYPE_HRID; a_repository: ARCHETYPE_REPOSITORY_I; a_directory: STRING): ARCH_CAT_ARCHETYPE
		do
			create Result.make_new_archetype (an_id, a_repository, a_directory)
		end

	create_arch_cat_archetype_make_new_specialised_archetype (an_id: ARCHETYPE_HRID; a_parent: DIFFERENTIAL_ARCHETYPE; a_repository: ARCHETYPE_REPOSITORY_I; a_directory: STRING): ARCH_CAT_ARCHETYPE
		do
