...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("Object deserialisation from dADL failed; type = $1", ec_deserialise_e1)
			...
			message_table.put ("No left delimiter ('<') found in line $1", ec_parse_dadl_missing_left_delim)
			message_table.put ("Missing right delimiter ('>') in line $1", ec_parse_dadl_missing_right_delim)
			message_table.put ("No attributes found, was expecting $1", ec_parse_dadl_no_attribs_found)
			...
			message_table.put ("Syntax error: invalid term code constraint pattern: $1", ec_SCPCV)
			...
			message_table.put ("$1 object node at path $2 use of node identifier does not conform to $3 node at parent path $4", ec_VSONI)
			...
			message_table.put ("Expecting CODE_PHRASE, e.g. [terminology_id::code]", ec_VONTBC)
			message_table.put ("Expecting primitive object node at path $1", ec_VONG)
			...
			message_table.put ("Unknown exception processing AOM profiles", ec_aom_profiles_unknown_exception)
			...
			message_table.put ("Doing complete build on current repository", ec_rep_populate_build_info)
			message_table.put ("No repository specified; add entries to .cfg file for current_repository_name in current_repository_name section", ec_repos_not_found_info)
			...
			message_table.put ("repository name", ec_repository_switch_arg_desc)
			...
			message_table.put ("Current repository: $1%N", ec_current_repo_info_text)
			message_table.put ("Loaded RM schemas (BMM files): %N", ec_rm_schemas_info_text)
			message_table.put ("No archetype ids matching pattern '$1' in repository $2 (use -s to see current config)%N", ec_no_matching_ids_err)
			message_table.put ("No repository with name '$1' (use -s to see all repositories)%N", ec_repo_does_not_exist_err)
			...
			message_table.put ("Removing invalid configuration (error: $1)", ec_remove_repo_cfg)
			message_table.put ("Repository error: $1", ec_repo_cfg_error)
			message_table.put ("Configuration $1 not known in repository configurations", ec_invalid_repo_cfg)
			message_table.put ("Reference Path $1 does not exist or not readable", ec_ref_repo_not_found)
			message_table.put ("Work Path $1 does not exist or not readable", ec_work_repo_not_found)
			message_table.put ("Work Path $1 is the same as or a child of the reference repository $2", ec_work_repo_not_valid)
			message_table.put ("Last configuration cannot be removed; use 'Edit' to reconfigure", ec_cant_remove_last_repo_cfg)
			message_table.put ("New configuration name $1 already used", ec_duplicate_repo_cfg)
			message_table.put ("Repository configuration name must not be empty", ec_empty_repo_cfg)
			message_table.put ("ADL Workbench Repository Configuration", ec_repository_dialog_title)
			message_table.put ("Repositories", ec_repo_cfg_list_text)
			message_table.put ("Add New", ec_add_new_repo_cfg_button_text)
			message_table.put ("Add a new repository configuration", ec_add_new_repo_cfg_button_tooltip)
			message_table.put ("Remove", ec_remove_repo_cfg_button_text)
			message_table.put ("Remove selected repository configuration", ec_remove_repo_cfg_button_tooltip)
			message_table.put ("Edit", ec_edit_repo_cfg_button_text)
			message_table.put ("Edit selected repository configuration", ec_edit_repo_cfg_button_tooltip)
			message_table.put ("Reference Path", ec_ref_repo_text)
			message_table.put ("Work Path", ec_work_repo_text)
			message_table.put ("Edit Repository Configuration", ec_repo_cfg_edit_dialog_title)
			message_table.put ("Repository Name:", ec_repo_cfg_name_text)
			message_table.put ("Reference Path:", ec_ref_repo_dir_text)
			message_table.put ("     Work Path:", ec_work_repo_dir_text)
			...
			message_table.put ("Show original creation form", ec_show_source_form_text)
			message_table.put ("Indicate original format  - ADL 1.4 legacy flat, ADL 1.5, etc", ec_show_source_form_tooltip)
			message_table.put ("Show all classes in explorer", ec_show_all_classes_text)
			message_table.put ("Show all archetypable classes in RM even if there are no archetypes based on them in the current repository.", ec_show_all_classes_tooltip)
			...
			message_table.put ("Matched Terminologies", ec_aom_profile_grid_term_col_title)
			...
			message_table.put ("Id $1 already exists in catalogue", ec_duplicate_archetype_id_err_msg)
			...
			message_table.put ("&Repository", ec_repository_menu_text)
			message_table.put ("&Build All", ec_repository_menu_build_all_text)
			message_table.put ("Rebuild &All", ec_repository_menu_rebuild_all_text)
			message_table.put ("Build Sub&tree", ec_repository_menu_build_subtree_text)
			message_table.put ("Rebuild S&ubtree", ec_repository_menu_rebuild_subtree_text)
			message_table.put ("&Interrupt Build", ec_repository_menu_interrupt_text)
			message_table.put ("Re&fresh Repository", ec_repository_menu_refresh_text)
			message_table.put ("Export as &HTML...", ec_repository_menu_export_html_text)
			message_table.put ("Export as &JSON...", ec_repository_menu_export_json_text)
			message_table.put ("Export as &YAML...", ec_repository_menu_export_yaml_text)
			message_table.put ("Export as &XML...", ec_repository_menu_export_xml_text)
			message_table.put ("&Export Repository Report...", ec_repository_menu_export_report_text)
			message_table.put ("&Configure Repositories...", ec_repository_menu_configure_text)
			...
			message_table.put ("Export Repository Report", ec_export_report_dialog_title)
			...
			message_table.put ("Select archetype repository", ec_repo_cfg_combo_tooltip)
			...
			message_table.put ("Exported report to $1", ec_export_repository_report_replace_info)
			message_table.put ("Failed to export report to $1", ec_export_repository_report_replace_err)
			...
			message_table.put ("Export repository in $1 format", ec_export_in_format_dialog_title)
			...
			message_table.put ("No diff directories available; tests must be run on repository first", ec_no_diff_dirs)
			message_table.put ("Populating from directories in $1 repository configuration...", ec_populating_directory_start)
			...
			message_table.put ("ADL 1.5 source files", ec_adl_15_source_files)
			message_table.put ("Edit $1", ec_catalogue_edit_dialog_title)
			message_table.put ("Differential", ec_catalogue_edit_differential_button_text)
			message_table.put ("Original source (ADL 1.4)", ec_catalogue_edit_adl14_button_text)
			message_table.put ("Archetypes", ec_catalogue_archetype_tab_text)
			message_table.put ("Templates", ec_catalogue_template_tab_text)
			message_table.put ("Metrics", ec_catalogue_metrics_tab_text)
			message_table.put ("Statistics", ec_catalogue_stats_tab_text)
			message_table.put ("Repository", ec_catalogue_tool_title)
			...
			message_table.put ("Nat lang", ec_nat_lang_checkbox_text)
			message_table.put ("this list may be incomplete. To be sure, run Build All under the Repository menu.", ec_slots_incomplete_w1)
			message_table.put ("Supplier Archetypes", ec_supplier_frame_text)
			message_table.put ("Client Archetypes", ec_client_frame_text)
			...
			message_table.put ("Completely expand the Node Map", ec_expand_complete_tooltip)
			message_table.put ("Expand All", ec_collapse_complete_button_text)
			message_table.put ("Completely collapse the Node Map", ec_collapse_complete_tooltip)
			message_table.put ("Expand One", ec_expand_one_level_button_text)
			message_table.put ("Expand one level of the Node Map", ec_expand_one_level_tooltip)
			message_table.put ("Collapse One", ec_collapse_one_level_button_text)
			message_table.put ("Collapse one level of the Node Map", ec_collapse_one_level_tooltip)
			...
			message_table.put ("Display code in ontology", ec_menu_option_display_code)
			...
			message_table.put ("Source", ec_source_tab_text)
			...
			message_table.put ("No message files found in directory $1", ec_msg_files_dir_empty)
			...
			message_table.put ("Schema $1 class definition $2 property $3 type not defined in schema", ec_BMM_PTV)
			...
			message_table.put ("$1 configuration settings (dADL format)", ec_config_settings_line1)
			...
			message_table.put ("dADL object duplicate attribute: $1", ec_VDATU)
			message_table.put ("dADL object key must be unique; key [$1] already exists under attribute '$2'", ec_VOKU)
end	
end