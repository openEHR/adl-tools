...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("Archetypes>Build Subtree", ec_menu_archetypes_build_subtree_key)
			message_table.put ("Archetypes>Rebuild Subtree", ec_menu_archetypes_rebuild_subtree_key)
			message_table.put ("Archetypes>Export HTML", ec_menu_archetypes_export_html_key)
			message_table.put ("Archetypes>Export JSON", ec_menu_archetypes_export_json_key)
			message_table.put ("Archetypes>Export YAML", ec_menu_archetypes_export_yaml_key)
			message_table.put ("Archetypes>Export XML", ec_menu_archetypes_export_xml_key)
			message_table.put ("Archetypes>Report", ec_menu_archetypes_report_key)
			...
			message_table.put ("IP%NAcknowledgements:", ec_ip_acknowledgements_label_text)
			message_table.put ("Conversion%NDetails:", ec_conversion_details_label_text)
