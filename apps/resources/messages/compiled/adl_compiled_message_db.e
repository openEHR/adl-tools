...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("term code $1 referenced in definition not defined in flat terminology", ec_VATDF)
			message_table.put ("value-set id code $1 referenced in definition not defined in flat terminology", ec_VACDF)
			...
			message_table.put ("ADL 1.5 converted", ec_adl_15_converted_tab_text)
			message_table.put ("ADL 1.5 source", ec_adl_15_source_tab_text)
			message_table.put ("ADL 1.5.1 source", ec_adl_151_source_tab_text)
			message_table.put ("ADL $1 source", ec_adl_ver_source_tab_text)
			message_table.put ("ADL 1.5.1 serialised", ec_adl_151_serialised_tab_text)
			message_table.put ("Save as ADL 1.5 source", ec_save_15_converted_button_text)
			message_table.put ("Save ADL 1.5.1 converted output into ADL 1.5 source file (overwrites current file)", ec_save_15_converted_button_tooltip)
			message_table.put ("Save as ADL 1.5 source", ec_save_151_serialised_button_text)
			message_table.put ("Save ADL 1.5.1 serialised output into ADL 1.5 source file (overwrites current file)", ec_save_151_serialised_button_tooltip)
			message_table.put ("Saved ADL 1.5.1 serialised output into $1", ec_saved_serialised_msg)
			message_table.put ("Saved ADL 1.5.1 converted output into $1", ec_saved_converted_msg)
			...
			message_table.put ("Values/ Value sets", ec_value_sets_grid_col_code_text)
			message_table.put ("Description", ec_value_sets_grid_col_description_text)
			message_table.put ("Text", ec_id_terms_grid_col_code_text)
