...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("node id-code $1 not defined in flat terminology", ec_VATID)
			message_table.put ("term code $1 not defined in flat terminology", ec_VATDF)
			message_table.put ("at-code $1 used in constraint not defined in flat terminology", ec_VATDC)
			message_table.put ("constraint code $1 not defined in flat terminology", ec_VACDF)
			...
			message_table.put ("code $1 in terminology more specialised than archetype", ec_VONSD)
			message_table.put ("code $1 in terminology not present in language $2", ec_VONLC)
			message_table.put ("expecting URI e.g. <xxx:some.domain/x/y/z?query#fragment> at path $1", ec_VONCBU)
			message_table.put ("expecting TERMINOLOGY_CODE, e.g. [terminology_id::code]", ec_VONTBC)
			...
			message_table.put ("ADL 1.5.1 serialised", ec_adl_15_serialised_tab_text)
			message_table.put ("Save as ADL 1.5 source", ec_save_15_button_text)
			message_table.put ("Save ADL 1.5.1 serialised output into ADL 1.5 source file (overwrites current file)", ec_save_15_button_tooltip)
