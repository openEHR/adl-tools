...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("IP Acknowledgements:", ec_ip_acknowledgements_label_text)
			message_table.put ("Conversion Details:", ec_conversion_details_label_text)
