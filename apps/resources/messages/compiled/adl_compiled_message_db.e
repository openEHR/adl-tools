...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("Syntax error: assumed value code $1 not found in code list", ec_STCAC)
			...
			message_table.put ("node id at-code $1 not defined in flat terminology", ec_VATDF)
			...
			message_table.put ("Value term code $1 invalid; must either be an archetype local term or a qualified external term", ec_VVST)
