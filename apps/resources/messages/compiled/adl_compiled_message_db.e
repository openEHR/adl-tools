...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("Could not execute external command (reason unknown)", ec_external_command_did_not_execute)
			...
			message_table.put ("If the repository is already cloned on your local system, choose its directory and hit OK.%NIf you want to clone the repository from the remote location, choose the PARENT directory%Nin which you want to create the clone and check the checkbox, then hit OK.", ec_repository_install_dialog_header_label)
