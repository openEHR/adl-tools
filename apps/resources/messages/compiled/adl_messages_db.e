...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("genreate reports", ec_report_switch_desc)
			...
			message_table.put ("Invalid report format '$1'; valid formats: $2%N", ec_invalid_report_format_err)
