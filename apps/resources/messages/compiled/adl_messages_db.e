...
feature -- Initialisation
	...
	make
		do
			...
			message_table.put ("==== finished building system: $1 total; $2 valid; $3 warnings; $4 errors ====%N", ec_compiler_finished_building_system)
			message_table.put ("==== rebuilding system from scratch", ec_compiler_rebuilding_system)
			message_table.put ("==== finished rebuilding system: $1 total; $2 valid; $3 warnings; $4 errors ====%N", ec_compiler_finished_rebuilding_system)
			...
			message_table.put ("output directory for serialised files", ec_output_dir_switch_arg_desc)
			...
			message_table.put ("Could not create output directory '$1'%N", ec_invalid_output_directory)
			...
			message_table.put ("ADL 1.4 path: ", ec_repository_legacy_dir_text)
			message_table.put ("Optionally specify ADL 1.4 legacy repository root directory.", ec_repository_legacy_dir_tooltip)
