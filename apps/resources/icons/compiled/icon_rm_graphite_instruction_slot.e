...
class ICON_RM_GRAPHITE_INSTRUCTION_SLOT
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "rm/graphite/instruction_slot"
			...
			"{
				{
					...
					A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,FF,FF,FF) A(FF,9A,9A,9A) A(FF,67,67,67) A(FF,FF,FF,FF) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(FF,AF,AF,AF) A(FF,8D,8D,8D) A(FF,6B,6B,6B) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,C4,C4,C4) 
					A(00,00,00,00) A(00,00,00,00) A(FF,FF,FF,FF) A(FF,A7,A7,A7) A(FF,70,70,70) A(FF,C3,C3,C3) A(FF,CD,CD,CD) A(FF,91,91,91) A(FF,58,58,58) A(00,00,00,00) 
					...
					A(FF,8F,8F,8F) A(FF,6B,6B,6B) A(FF,FF,FF,FF) A(FF,87,87,87) A(FF,71,71,71) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,AD,AD,AD) A(FF,AD,AD,AD) 
					...
					A(FF,5D,5D,5D) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,EA,EA,EA) 
					A(FF,80,80,80) A(FF,FF,FF,FF) A(FF,88,88,88) A(FF,76,76,76) A(00,00,00,00) A(FF,AE,AE,AE) A(FF,51,51,51) A(FF,FF,FF,FF) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(00,00,00,00) A(FF,AF,AF,AF) A(FF,4B,4B,4B) A(FF,FF,FF,FF) A(FF,00,00,80) A(FF,01,34,8D) A(FF,A6,A6,A6) A(FF,A6,A6,A6) A(FF,A7,A7,A7) A(FF,7C,7C,7C) 
					A(FF,6C,6C,6C) A(FF,D7,D7,D7) A(00,00,00,00) A(FF,CE,CE,CE) A(FF,96,96,96) A(FF,5C,5C,5C) A(00,00,00,00) A(FF,AB,AB,AB) A(FF,4B,4B,4B) A(FF,FF,FF,FF) 
					...
					A(FF,94,94,94) A(FF,7A,7A,7A) A(FF,FF,FF,FF) A(FF,99,99,99) A(FF,5A,5A,5A) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) 
					...
					A(FF,68,68,68) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) 
					A(FF,FF,FF,FF) A(FF,B8,B8,B8) A(FF,80,80,80) A(00,00,00,00) A(FF,C8,C8,C8) A(FF,95,95,95) A(FF,75,75,75) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(FF,B5,B5,B5) A(FF,6A,6A,6A) A(FF,C9,C9,C9) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) 
