...
class ICON_AM_INHERITED_ARCHETYPE_SLOT
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "am/inherited/archetype_slot"
			...
			"{
				{
					...
					A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) 
					A(FF,FF,FF,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) 
					...
					A(FF,FF,FF,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,80,80,80) 
					A(FF,80,80,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,FF,FF,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,FF,FF,FF) A(FF,80,80,80) 
					A(FF,80,80,80) A(FF,80,80,80) A(FF,C0,C0,C0) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,80,80,80) A(FF,80,80,80) A(FF,80,80,80) A(FF,FF,FF,80) A(FF,FF,FF,80) 
					...
					A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,C0,C0,C0) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,C0,C0,C0) A(FF,80,80,80) 
