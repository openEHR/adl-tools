...
feature -- Access
	...
	icon_load_agents: HASH_TABLE [FUNCTION [ANY, TUPLE, EV_PIXMAP], STRING]
		...
		once
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_GENERIC_ABSTRACT}.make).to_pixmap end, "rm/generic/class_generic_abstract")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_GENERIC_CONCRETE}.make).to_pixmap end, "rm/generic/class_generic_concrete")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_GENERIC_EFFECTIVE}.make).to_pixmap end, "rm/generic/class_generic_effective")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CONTAINER_TYPE_ABSTRACT}.make).to_pixmap end, "rm/generic/container_type_abstract")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CONTAINER_TYPE_CONCRETE}.make).to_pixmap end, "rm/generic/container_type_concrete")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_GENERIC_PARAMETER_CONSTRAINED}.make).to_pixmap end, "rm/generic/generic_parameter_constrained")
