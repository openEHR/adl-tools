...
feature -- Access
	...
	icon_load_agents: HASH_TABLE [FUNCTION [ANY, TUPLE, EV_PIXMAP], STRING]
		...
		once
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSERTION}.make).to_pixmap end, "rm/graphite/assertion")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSERTION32X32}.make).to_pixmap end, "rm/graphite/assertion32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSERTION_REFERENCE}.make).to_pixmap end, "rm/graphite/assertion_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSERTION_SLOT}.make).to_pixmap end, "rm/graphite/assertion_slot")
