...
feature -- Access
	...
	icon_load_agents: HASH_TABLE [FUNCTION [ANY, TUPLE, EV_PIXMAP], STRING]
		...
		once
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ACTION}.make).to_pixmap end, "rm/graphite/action")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ACTION_REFERENCE}.make).to_pixmap end, "rm/graphite/action_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ACTION_SLOT}.make).to_pixmap end, "rm/graphite/action_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ACTIVITY}.make).to_pixmap end, "rm/graphite/activity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADDRESS}.make).to_pixmap end, "rm/graphite/address")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADDRESS_REFERENCE}.make).to_pixmap end, "rm/graphite/address_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADDRESS_SLOT}.make).to_pixmap end, "rm/graphite/address_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADHOC_BRANCH}.make).to_pixmap end, "rm/graphite/adhoc_branch")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADHOC_GROUP}.make).to_pixmap end, "rm/graphite/adhoc_group")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADMIN_ENTRY}.make).to_pixmap end, "rm/graphite/admin_entry")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADMIN_ENTRY_REFERENCE}.make).to_pixmap end, "rm/graphite/admin_entry_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ADMIN_ENTRY_SLOT}.make).to_pixmap end, "rm/graphite/admin_entry_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_AGENT}.make).to_pixmap end, "rm/graphite/agent")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ANY}.make).to_pixmap end, "rm/graphite/any")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_API_CALL}.make).to_pixmap end, "rm/graphite/api_call")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSESSMENT}.make).to_pixmap end, "rm/graphite/assessment")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSESSMENT32X32}.make).to_pixmap end, "rm/graphite/assessment32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSESSMENT_REFERENCE}.make).to_pixmap end, "rm/graphite/assessment_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ASSESSMENT_SLOT}.make).to_pixmap end, "rm/graphite/assessment_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_BOOLEAN_VALUE}.make).to_pixmap end, "rm/graphite/boolean_value")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CAPABILITY}.make).to_pixmap end, "rm/graphite/capability")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CARE_ACT_ENTRY}.make).to_pixmap end, "rm/graphite/care_act_entry")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CARE_ACT_ENTRY32X32}.make).to_pixmap end, "rm/graphite/care_act_entry32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CARE_ENTRY}.make).to_pixmap end, "rm/graphite/care_entry")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CARE_ENTRY32X32}.make).to_pixmap end, "rm/graphite/care_entry32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CLUSTER}.make).to_pixmap end, "rm/graphite/cluster")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CLUSTER_REFERENCE}.make).to_pixmap end, "rm/graphite/cluster_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CLUSTER_SLOT}.make).to_pixmap end, "rm/graphite/cluster_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CODED_TEXT}.make).to_pixmap end, "rm/graphite/coded_text")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_COMPOSITION}.make).to_pixmap end, "rm/graphite/composition")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_COMPOSITION_REFERENCE}.make).to_pixmap end, "rm/graphite/composition_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_COMPOSITION_SLOT}.make).to_pixmap end, "rm/graphite/composition_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CONDITION_BRANCH}.make).to_pixmap end, "rm/graphite/condition_branch")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CONDITION_GROUP}.make).to_pixmap end, "rm/graphite/condition_group")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CONTACT}.make).to_pixmap end, "rm/graphite/contact")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CONTENT_ITEM}.make).to_pixmap end, "rm/graphite/content_item")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_CONTENT_ITEM32X32}.make).to_pixmap end, "rm/graphite/content_item32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_COUNT}.make).to_pixmap end, "rm/graphite/count")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DATE_TIME_VALUE}.make).to_pixmap end, "rm/graphite/date_time_value")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DATE_VALUE}.make).to_pixmap end, "rm/graphite/date_value")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DECISION_BRANCH}.make).to_pixmap end, "rm/graphite/decision_branch")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DECISION_GROUP}.make).to_pixmap end, "rm/graphite/decision_group")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DEFINED_ACTION}.make).to_pixmap end, "rm/graphite/defined_action")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DIRECT_OBSERVATION}.make).to_pixmap end, "rm/graphite/direct_observation")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DIRECT_OBSERVATION_REFERENCE}.make).to_pixmap end, "rm/graphite/direct_observation_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DIRECT_OBSERVATION_SLOT}.make).to_pixmap end, "rm/graphite/direct_observation_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DISPATCHABLE_TASK}.make).to_pixmap end, "rm/graphite/dispatchable_task")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_DURATION_VALUE}.make).to_pixmap end, "rm/graphite/duration_value")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ELEMENT}.make).to_pixmap end, "rm/graphite/element")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ELEMENT_REFERENCE}.make).to_pixmap end, "rm/graphite/element_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ELEMENT_SLOT}.make).to_pixmap end, "rm/graphite/element_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ENTRY}.make).to_pixmap end, "rm/graphite/entry")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ENTRY32X32}.make).to_pixmap end, "rm/graphite/entry32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ENTRY_REFERENCE}.make).to_pixmap end, "rm/graphite/entry_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ENTRY_SLOT}.make).to_pixmap end, "rm/graphite/entry_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_EVENT}.make).to_pixmap end, "rm/graphite/event")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_EVENT32X32}.make).to_pixmap end, "rm/graphite/event32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_EVENT_VARIABLE}.make).to_pixmap end, "rm/graphite/event_variable")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_EXTERNAL_REQUEST}.make).to_pixmap end, "rm/graphite/external_request")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_EXTRACT}.make).to_pixmap end, "rm/graphite/extract")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_FOLDER}.make).to_pixmap end, "rm/graphite/folder")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_GROUP}.make).to_pixmap end, "rm/graphite/group")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_HAND_OFF}.make).to_pixmap end, "rm/graphite/hand_off")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_HISTORY}.make).to_pixmap end, "rm/graphite/history")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_HISTORY32X32}.make).to_pixmap end, "rm/graphite/history32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_IMAGING}.make).to_pixmap end, "rm/graphite/imaging")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_IMAGING_REFERENCE}.make).to_pixmap end, "rm/graphite/imaging_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_IMAGING_SLOT}.make).to_pixmap end, "rm/graphite/imaging_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INDIRECT_OBSERVATION}.make).to_pixmap end, "rm/graphite/indirect_observation")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INDIRECT_OBSERVATION_REFERENCE}.make).to_pixmap end, "rm/graphite/indirect_observation_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INDIRECT_OBSERVATION_SLOT}.make).to_pixmap end, "rm/graphite/indirect_observation_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INTERVAL_COUNT}.make).to_pixmap end, "rm/graphite/interval_count")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INTERVAL_DATE_TIME}.make).to_pixmap end, "rm/graphite/interval_date_time")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INTERVAL_DURATION}.make).to_pixmap end, "rm/graphite/interval_duration")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INTERVAL_EVENT}.make).to_pixmap end, "rm/graphite/interval_event")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INTERVAL_EVENT32X32}.make).to_pixmap end, "rm/graphite/interval_event32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INTERVAL_QUANTITY}.make).to_pixmap end, "rm/graphite/interval_quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ITEM}.make).to_pixmap end, "rm/graphite/item")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_LAB_RESULT}.make).to_pixmap end, "rm/graphite/lab_result")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_LAB_RESULT_REFERENCE}.make).to_pixmap end, "rm/graphite/lab_result_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_LAB_RESULT_SLOT}.make).to_pixmap end, "rm/graphite/lab_result_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_LINK}.make).to_pixmap end, "rm/graphite/link")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_MULTIMEDIA}.make).to_pixmap end, "rm/graphite/multimedia")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_OBJECT_REF}.make).to_pixmap end, "rm/graphite/object_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_OBSERVATION}.make).to_pixmap end, "rm/graphite/observation")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_OBSERVATION_REFERENCE}.make).to_pixmap end, "rm/graphite/observation_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_OBSERVATION_SLOT}.make).to_pixmap end, "rm/graphite/observation_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORDER}.make).to_pixmap end, "rm/graphite/order")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORDER_REFERENCE}.make).to_pixmap end, "rm/graphite/order_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORDER_SLOT}.make).to_pixmap end, "rm/graphite/order_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORDINAL}.make).to_pixmap end, "rm/graphite/ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORGANISATION}.make).to_pixmap end, "rm/graphite/organisation")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORGANISATION_REFERENCE}.make).to_pixmap end, "rm/graphite/organisation_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ORGANISATION_SLOT}.make).to_pixmap end, "rm/graphite/organisation_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARSABLE}.make).to_pixmap end, "rm/graphite/parsable")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTICIPATION}.make).to_pixmap end, "rm/graphite/participation")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTY_IDENTITY}.make).to_pixmap end, "rm/graphite/party_identity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTY_IDENTITY_REFERENCE}.make).to_pixmap end, "rm/graphite/party_identity_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTY_IDENTITY_SLOT}.make).to_pixmap end, "rm/graphite/party_identity_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTY_PROXY}.make).to_pixmap end, "rm/graphite/party_proxy")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTY_REF}.make).to_pixmap end, "rm/graphite/party_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PARTY_RELATIONSHIP}.make).to_pixmap end, "rm/graphite/party_relationship")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PERFORMABLE_TASK}.make).to_pixmap end, "rm/graphite/performable_task")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PERSON}.make).to_pixmap end, "rm/graphite/person")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PERSON_REFERENCE}.make).to_pixmap end, "rm/graphite/person_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PERSON_SLOT}.make).to_pixmap end, "rm/graphite/person_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PLAIN_TEXT}.make).to_pixmap end, "rm/graphite/plain_text")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_PLAN_DATA_CONTEXT}.make).to_pixmap end, "rm/graphite/plan_data_context")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_POINT_EVENT}.make).to_pixmap end, "rm/graphite/point_event")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_POINT_EVENT32X32}.make).to_pixmap end, "rm/graphite/point_event32x32")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_QUANTITY}.make).to_pixmap end, "rm/graphite/quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_QUERY_CALL}.make).to_pixmap end, "rm/graphite/query_call")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_QUESTIONNAIRE_RESPONSE}.make).to_pixmap end, "rm/graphite/questionnaire_response")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_QUESTIONNAIRE_RESPONSE_REFERENCE}.make).to_pixmap end, "rm/graphite/questionnaire_response_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_QUESTIONNAIRE_RESPONSE_SLOT}.make).to_pixmap end, "rm/graphite/questionnaire_response_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_RANGE}.make).to_pixmap end, "rm/graphite/range")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_RATIO}.make).to_pixmap end, "rm/graphite/ratio")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ROLE}.make).to_pixmap end, "rm/graphite/role")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_RWE_ID_REF}.make).to_pixmap end, "rm/graphite/rwe_id_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SCORE}.make).to_pixmap end, "rm/graphite/score")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SCORE_REFERENCE}.make).to_pixmap end, "rm/graphite/score_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SCORE_SLOT}.make).to_pixmap end, "rm/graphite/score_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SECTION}.make).to_pixmap end, "rm/graphite/section")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SECTION_REFERENCE}.make).to_pixmap end, "rm/graphite/section_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SECTION_SLOT}.make).to_pixmap end, "rm/graphite/section_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_STATE_TRANSITION}.make).to_pixmap end, "rm/graphite/state_transition")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_STATE_VARIABLE}.make).to_pixmap end, "rm/graphite/state_variable")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_STRUCTURE}.make).to_pixmap end, "rm/graphite/structure")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SUB_PLAN}.make).to_pixmap end, "rm/graphite/sub_plan")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_SYSTEM_REQUEST}.make).to_pixmap end, "rm/graphite/system_request")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TASK}.make).to_pixmap end, "rm/graphite/task")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TASK_GROUP}.make).to_pixmap end, "rm/graphite/task_group")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TASK_PLAN}.make).to_pixmap end, "rm/graphite/task_plan")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TERMINOLOGY_TERM}.make).to_pixmap end, "rm/graphite/terminology_term")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TEXT}.make).to_pixmap end, "rm/graphite/text")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TIME_VALUE}.make).to_pixmap end, "rm/graphite/time_value")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TYPE_DEF_BOOLEAN}.make).to_pixmap end, "rm/graphite/type_def_boolean")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TYPE_DEF_INTEGER}.make).to_pixmap end, "rm/graphite/type_def_integer")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_TYPE_DEF_STRING}.make).to_pixmap end, "rm/graphite/type_def_string")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_URI_VALUE}.make).to_pixmap end, "rm/graphite/uri_value")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_WORK_PLAN}.make).to_pixmap end, "rm/graphite/work_plan")
