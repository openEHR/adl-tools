...
feature -- Access
	...
	icon_load_agents: HASH_TABLE [FUNCTION [ANY, TUPLE, EV_PIXMAP], STRING]
		...
		once
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INSTRUCTION}.make).to_pixmap end, "rm/graphite/instruction")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INSTRUCTION_REFERENCE}.make).to_pixmap end, "rm/graphite/instruction_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_INSTRUCTION_SLOT}.make).to_pixmap end, "rm/graphite/instruction_slot")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GRAPHITE_ISM_TRANSITION}.make).to_pixmap end, "rm/graphite/ism_transition")
