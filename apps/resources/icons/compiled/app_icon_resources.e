...
feature -- Access
	...
	icon_load_agents: HASH_TABLE [FUNCTION [ANY, TUPLE, EV_PIXMAP], STRING]
		...
		once
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_CLUSTER}.make).to_pixmap end, "rm/s2/cluster")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_CLUSTER_REFERENCE}.make).to_pixmap end, "rm/s2/cluster_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_CLUSTER_SLOT}.make).to_pixmap end, "rm/s2/cluster_slot")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_ELEMENT}.make).to_pixmap end, "rm/s2/element")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_ELEMENT_REFERENCE}.make).to_pixmap end, "rm/s2/element_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_ELEMENT_SLOT}.make).to_pixmap end, "rm/s2/element_slot")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_IMAGING}.make).to_pixmap end, "rm/s2/imaging")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_IMAGING_REFERENCE}.make).to_pixmap end, "rm/s2/imaging_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_IMAGING_SLOT}.make).to_pixmap end, "rm/s2/imaging_slot")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_LAB_RESULT}.make).to_pixmap end, "rm/s2/lab_result")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_LAB_RESULT_REFERENCE}.make).to_pixmap end, "rm/s2/lab_result_reference")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_LAB_RESULT_SLOT}.make).to_pixmap end, "rm/s2/lab_result_slot")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_S2_ORDINAL}.make).to_pixmap end, "rm/s2/ordinal")
