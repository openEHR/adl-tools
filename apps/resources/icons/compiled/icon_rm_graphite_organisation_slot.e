...
class ICON_RM_GRAPHITE_ORGANISATION_SLOT
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "rm/graphite/organisation_slot"
			...
			"{
				{
					...
					A(FF,01,34,8D) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,D2,BD,C1) A(FF,B4,B8,BB) A(FF,53,51,4F) A(FF,73,74,76) A(FF,67,68,6A) A(FF,71,72,73) 
					A(FF,85,86,88) A(FF,73,74,76) A(FF,66,68,69) A(FF,75,74,74) A(FF,5E,5C,5D) A(FF,5B,5C,5E) A(FF,8C,8D,90) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(FF,60,61,64) A(FF,81,89,91) A(FF,A9,A8,A7) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,A5,B1,B9) A(FF,ED,FF,FF) A(FF,B1,B9,BF) A(FF,A3,AE,B5) 
					...
					A(FF,BD,D7,E3) A(FF,B9,B6,B5) A(FF,47,74,93) A(FF,A3,AA,B2) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,BA,BF,C2) A(FF,B5,C3,CC) 
					...
					A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,BC,C1,C5) A(FF,BE,CD,D3) A(FF,CA,DC,E5) A(FF,A7,A7,AA) A(FF,DC,F5,FF) A(FF,B1,C0,C9) 
					A(FF,AB,BA,C1) A(FF,C8,D2,D9) A(FF,B2,B9,BD) A(FF,8B,9A,A8) A(FF,67,7F,92) A(FF,DC,CE,C9) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(FF,9F,9C,9C) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(FF,AB,B0,B4) A(FF,D4,E9,F2) A(FF,B2,B6,B9) 
					...
					A(FF,B1,B0,AF) A(FF,67,88,A1) A(FF,AC,AB,AA) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(FF,BC,C1,C4) 
					...
					A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(FF,B1,C5,CF) A(FF,C7,CF,D4) A(FF,3A,3A,3D) A(FF,4D,4C,4F) 
					A(FF,D0,E5,EE) A(FF,B4,C2,CA) A(FF,7D,8D,9B) A(FF,70,9B,83) A(FF,F1,EF,A1) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) 
