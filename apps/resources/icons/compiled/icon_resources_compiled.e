...
feature {NONE} -- Implementation
	...
	load_icon_agents: HASH_TABLE [FUNCTION [ANY, TUPLE, EV_PIXMAP], STRING]
		...
		once
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_EXTERNAL_REF}.make).to_pixmap end, "am/added/archetype_external_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_EXTERNAL_REF_MULTIPLE}.make).to_pixmap end, "am/added/archetype_external_ref.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_EXTERNAL_REF_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/added/archetype_external_ref.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_EXTERNAL_REF_OPTIONAL}.make).to_pixmap end, "am/added/archetype_external_ref.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_INTERNAL_REF}.make).to_pixmap end, "am/added/archetype_internal_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_INTERNAL_REF_BALL}.make).to_pixmap end, "am/added/archetype_internal_ref_ball")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_SLOT}.make).to_pixmap end, "am/added/archetype_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_SLOT_MULTIPLE}.make).to_pixmap end, "am/added/archetype_slot.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ARCHETYPE_SLOT_OPTIONAL}.make).to_pixmap end, "am/added/archetype_slot.optional")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_CONSTRAINT_REF}.make).to_pixmap end, "am/added/constraint_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ARCHETYPE_ROOT}.make).to_pixmap end, "am/added/c_archetype_root")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE}.make).to_pixmap end, "am/added/c_attribute")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_MULTIPLE}.make).to_pixmap end, "am/added/c_attribute.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/added/c_attribute.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_OPTIONAL}.make).to_pixmap end, "am/added/c_attribute.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_COMPUTED}.make).to_pixmap end, "am/added/c_attribute_computed")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_COMPUTED_MULTIPLE}.make).to_pixmap end, "am/added/c_attribute_computed.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_COMPUTED_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/added/c_attribute_computed.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_ATTRIBUTE_COMPUTED_OPTIONAL}.make).to_pixmap end, "am/added/c_attribute_computed.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_CODE_PHRASE}.make).to_pixmap end, "am/added/c_code_phrase")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_COMPLEX_OBJECT}.make).to_pixmap end, "am/added/c_complex_object")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_COMPLEX_OBJECT_MULTIPLE}.make).to_pixmap end, "am/added/c_complex_object.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_COMPLEX_OBJECT_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/added/c_complex_object.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_COMPLEX_OBJECT_OPTIONAL}.make).to_pixmap end, "am/added/c_complex_object.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_DV_ORDINAL}.make).to_pixmap end, "am/added/c_dv_ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_DV_QUANTITY}.make).to_pixmap end, "am/added/c_dv_quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_PRIMITIVE_OBJECT}.make).to_pixmap end, "am/added/c_primitive_object")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_C_QUANTITY_ITEM}.make).to_pixmap end, "am/added/c_quantity_item")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_ORDINAL}.make).to_pixmap end, "am/added/ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_ADDED_QUANTITY}.make).to_pixmap end, "am/added/quantity")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_EXTERNAL_REF}.make).to_pixmap end, "am/inherited/archetype_external_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_EXTERNAL_REF_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/inherited/archetype_external_ref.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_EXTERNAL_REF_OPTIONAL}.make).to_pixmap end, "am/inherited/archetype_external_ref.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_EXTERNAL_REF_MULTIPLE}.make).to_pixmap end, "am/inherited/archetype_external_ref_multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_INTERNAL_REF}.make).to_pixmap end, "am/inherited/archetype_internal_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_SLOT}.make).to_pixmap end, "am/inherited/archetype_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_SLOT_MULTIPLE}.make).to_pixmap end, "am/inherited/archetype_slot.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ARCHETYPE_SLOT_OPTIONAL}.make).to_pixmap end, "am/inherited/archetype_slot.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_CONSTRAINT_REF}.make).to_pixmap end, "am/inherited/constraint_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ARCHETYPE_ROOT}.make).to_pixmap end, "am/inherited/c_archetype_root")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE}.make).to_pixmap end, "am/inherited/c_attribute")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_MULTIPLE}.make).to_pixmap end, "am/inherited/c_attribute.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/inherited/c_attribute.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_OPTIONAL}.make).to_pixmap end, "am/inherited/c_attribute.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_COMPUTED}.make).to_pixmap end, "am/inherited/c_attribute_computed")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_COMPUTED_MULTIPLE}.make).to_pixmap end, "am/inherited/c_attribute_computed.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_COMPUTED_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/inherited/c_attribute_computed.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_ATTRIBUTE_COMPUTED_OPTIONAL}.make).to_pixmap end, "am/inherited/c_attribute_computed.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_CODE_PHRASE}.make).to_pixmap end, "am/inherited/c_code_phrase")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_COMPLEX_OBJECT}.make).to_pixmap end, "am/inherited/c_complex_object")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_COMPLEX_OBJECT_MULTIPLE}.make).to_pixmap end, "am/inherited/c_complex_object.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_COMPLEX_OBJECT_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/inherited/c_complex_object.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_COMPLEX_OBJECT_OPTIONAL}.make).to_pixmap end, "am/inherited/c_complex_object.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_DV_ORDINAL}.make).to_pixmap end, "am/inherited/c_dv_ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_DV_QUANTITY}.make).to_pixmap end, "am/inherited/c_dv_quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_PRIMITIVE_OBJECT}.make).to_pixmap end, "am/inherited/c_primitive_object")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_C_QUANTITY_ITEM}.make).to_pixmap end, "am/inherited/c_quantity_item")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_ORDINAL}.make).to_pixmap end, "am/inherited/ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_QUANTITY}.make).to_pixmap end, "am/inherited/quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_INHERITED_TERM}.make).to_pixmap end, "am/inherited/term")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_EXTERNAL_REF}.make).to_pixmap end, "am/redefined/archetype_external_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_EXTERNAL_REF_MULTIPLE}.make).to_pixmap end, "am/redefined/archetype_external_ref.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_EXTERNAL_REF_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/redefined/archetype_external_ref.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_EXTERNAL_REF_OPTIONAL}.make).to_pixmap end, "am/redefined/archetype_external_ref.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_INTERNAL_REF}.make).to_pixmap end, "am/redefined/archetype_internal_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_SLOT}.make).to_pixmap end, "am/redefined/archetype_slot")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_SLOT_MULTIPLE}.make).to_pixmap end, "am/redefined/archetype_slot.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ARCHETYPE_SLOT_OPTIONAL}.make).to_pixmap end, "am/redefined/archetype_slot.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_CONSTRAINT_REF}.make).to_pixmap end, "am/redefined/constraint_ref")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ARCHETYPE_ROOT}.make).to_pixmap end, "am/redefined/c_archetype_root")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE}.make).to_pixmap end, "am/redefined/c_attribute")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_MULTIPLE}.make).to_pixmap end, "am/redefined/c_attribute.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/redefined/c_attribute.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_OPTIONAL}.make).to_pixmap end, "am/redefined/c_attribute.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_COMPUTED}.make).to_pixmap end, "am/redefined/c_attribute_computed")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_COMPUTED_MULTIPLE}.make).to_pixmap end, "am/redefined/c_attribute_computed.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_COMPUTED_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/redefined/c_attribute_computed.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_ATTRIBUTE_COMPUTED_OPTIONAL}.make).to_pixmap end, "am/redefined/c_attribute_computed.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_CODE_PHRASE}.make).to_pixmap end, "am/redefined/c_code_phrase")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_COMPLEX_OBJECT}.make).to_pixmap end, "am/redefined/c_complex_object")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_COMPLEX_OBJECT_MULTIPLE}.make).to_pixmap end, "am/redefined/c_complex_object.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_COMPLEX_OBJECT_MULTIPLE_OPTIONAL}.make).to_pixmap end, "am/redefined/c_complex_object.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_COMPLEX_OBJECT_OPTIONAL}.make).to_pixmap end, "am/redefined/c_complex_object.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_DV_ORDINAL}.make).to_pixmap end, "am/redefined/c_dv_ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_DV_QUANTITY}.make).to_pixmap end, "am/redefined/c_dv_quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_PRIMITIVE_OBJECT}.make).to_pixmap end, "am/redefined/c_primitive_object")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_C_QUANTITY_ITEM}.make).to_pixmap end, "am/redefined/c_quantity_item")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ICON_HELP_EXAMPLE}.make).to_pixmap end, "am/redefined/icon_help_example")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_ORDINAL}.make).to_pixmap end, "am/redefined/ordinal")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_QUANTITY}.make).to_pixmap end, "am/redefined/quantity")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_AM_REDEFINED_TERM}.make).to_pixmap end, "am/redefined/term")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_1}.make).to_pixmap end, "archetype/archetype_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_2}.make).to_pixmap end, "archetype/archetype_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_3}.make).to_pixmap end, "archetype/archetype_3")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_PARSED_1}.make).to_pixmap end, "archetype/archetype_parsed_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_PARSED_2}.make).to_pixmap end, "archetype/archetype_parsed_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_PARSED_3}.make).to_pixmap end, "archetype/archetype_parsed_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_PARSE_FAILED_1}.make).to_pixmap end, "archetype/archetype_parse_failed_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_PARSE_FAILED_2}.make).to_pixmap end, "archetype/archetype_parse_failed_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_PARSE_FAILED_3}.make).to_pixmap end, "archetype/archetype_parse_failed_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_VALID_1}.make).to_pixmap end, "archetype/archetype_valid_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_VALID_2}.make).to_pixmap end, "archetype/archetype_valid_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_VALID_3}.make).to_pixmap end, "archetype/archetype_valid_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_WARNING_1}.make).to_pixmap end, "archetype/archetype_warning_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_WARNING_2}.make).to_pixmap end, "archetype/archetype_warning_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_ARCHETYPE_WARNING_3}.make).to_pixmap end, "archetype/archetype_warning_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_CLASS_ABSTRACT}.make).to_pixmap end, "archetype/class_abstract")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_CLASS_CONCRETE}.make).to_pixmap end, "archetype/class_concrete")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_CLASS_CONCRETE_GENERIC}.make).to_pixmap end, "archetype/class_concrete_generic")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_CLASS_CONCRETE_SUPERTYPE}.make).to_pixmap end, "archetype/class_concrete_supertype")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_CLASS_PRIMITIVE}.make).to_pixmap end, "archetype/class_primitive")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_FILE_FOLDER_2}.make).to_pixmap end, "archetype/file_folder_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_FILE_FOLDER_3}.make).to_pixmap end, "archetype/file_folder_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_MODEL_GROUP}.make).to_pixmap end, "archetype/model_group")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_1}.make).to_pixmap end, "archetype/template_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_2}.make).to_pixmap end, "archetype/template_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_3}.make).to_pixmap end, "archetype/template_3")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_1}.make).to_pixmap end, "archetype/template_overlay_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_2}.make).to_pixmap end, "archetype/template_overlay_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_3}.make).to_pixmap end, "archetype/template_overlay_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_PARSED_1}.make).to_pixmap end, "archetype/template_overlay_parsed_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_PARSED_2}.make).to_pixmap end, "archetype/template_overlay_parsed_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_PARSED_3}.make).to_pixmap end, "archetype/template_overlay_parsed_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_PARSE_FAILED_1}.make).to_pixmap end, "archetype/template_overlay_parse_failed_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_PARSE_FAILED_2}.make).to_pixmap end, "archetype/template_overlay_parse_failed_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_PARSE_FAILED_3}.make).to_pixmap end, "archetype/template_overlay_parse_failed_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_VALID_1}.make).to_pixmap end, "archetype/template_overlay_valid_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_VALID_2}.make).to_pixmap end, "archetype/template_overlay_valid_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_VALID_3}.make).to_pixmap end, "archetype/template_overlay_valid_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_WARNING_1}.make).to_pixmap end, "archetype/template_overlay_warning_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_WARNING_2}.make).to_pixmap end, "archetype/template_overlay_warning_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_OVERLAY_WARNING_3}.make).to_pixmap end, "archetype/template_overlay_warning_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_PARSED_1}.make).to_pixmap end, "archetype/template_parsed_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_PARSED_2}.make).to_pixmap end, "archetype/template_parsed_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_PARSED_3}.make).to_pixmap end, "archetype/template_parsed_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_PARSE_FAILED_1}.make).to_pixmap end, "archetype/template_parse_failed_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_PARSE_FAILED_2}.make).to_pixmap end, "archetype/template_parse_failed_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_PARSE_FAILED_3}.make).to_pixmap end, "archetype/template_parse_failed_3")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_VALID_1}.make).to_pixmap end, "archetype/template_valid_1")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_VALID_2}.make).to_pixmap end, "archetype/template_valid_2")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_ARCHETYPE_TEMPLATE_VALID_3}.make).to_pixmap end, "archetype/template_valid_3")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_CIMI_DV_BOOLEAN}.make).to_pixmap end, "rm/cimi/dv_boolean")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_ABSTRACT}.make).to_pixmap end, "rm/generic/class_abstract")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_ABSTRACT_OVERRIDE}.make).to_pixmap end, "rm/generic/class_abstract_override")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_CONCRETE}.make).to_pixmap end, "rm/generic/class_concrete")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_CONCRETE_GENERIC}.make).to_pixmap end, "rm/generic/class_concrete_generic")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_CONCRETE_OVERRIDE}.make).to_pixmap end, "rm/generic/class_concrete_override")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_CONCRETE_SUPERTYPE}.make).to_pixmap end, "rm/generic/class_concrete_supertype")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_CONCRETE_SUPERTYPE_OVERRIDE}.make).to_pixmap end, "rm/generic/class_concrete_supertype_override")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CLASS_PRIMITIVE}.make).to_pixmap end, "rm/generic/class_primitive")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_CONSTRAINED_GENERIC_PARAMETER}.make).to_pixmap end, "rm/generic/constrained_generic_parameter")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE}.make).to_pixmap end, "rm/generic/c_attribute")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_MULTIPLE}.make).to_pixmap end, "rm/generic/c_attribute.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_MULTIPLE_OPTIONAL}.make).to_pixmap end, "rm/generic/c_attribute.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_OPTIONAL}.make).to_pixmap end, "rm/generic/c_attribute.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_COMPUTED}.make).to_pixmap end, "rm/generic/c_attribute_computed")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_COMPUTED_MULTIPLE}.make).to_pixmap end, "rm/generic/c_attribute_computed.multiple")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_COMPUTED_MULTIPLE_OPTIONAL}.make).to_pixmap end, "rm/generic/c_attribute_computed.multiple.optional")
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_C_ATTRIBUTE_COMPUTED_OPTIONAL}.make).to_pixmap end, "rm/generic/c_attribute_computed.optional")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_GENERIC_GENERIC_PARAMETER}.make).to_pixmap end, "rm/generic/generic_parameter")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_RM_OPENEHR_DT_TIME}.make).to_pixmap end, "rm/openehr/dt_time")
			...
			Result.put (agent :EV_PIXMAP do Result := (create {ICON_TOOL_ARCHETYPE_CATEGORY}.make).to_pixmap end, "tool/archetype_category")
