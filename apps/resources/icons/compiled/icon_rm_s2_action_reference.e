...
class ICON_RM_GRAPHITE_ACTION_REFERENCE
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "rm/graphite/action_reference"
			...
			"{
				{
					...
					A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(FF,71,71,71) A(FF,6A,6A,6A) A(FF,5E,5E,5E) A(FF,7C,7C,7C) 
					A(FF,80,80,80) A(FF,7C,7C,7C) A(FF,67,67,67) A(FF,73,73,73) A(FF,99,99,99) A(00,00,00,00) A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(00,00,00,00) A(FF,D8,D8,D8) A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(FF,96,96,96) A(FF,A0,A0,A0) A(FF,B1,B1,B1) A(FF,C2,C2,C2) 
					A(FF,98,98,98) A(FF,B6,B6,B6) A(FF,CE,CE,CE) A(FF,A8,A8,A8) A(FF,96,96,96) A(FF,97,97,97) A(FF,AA,AA,AA) A(FF,8F,8F,8F) A(FF,01,34,8D) A(FF,00,00,80) 
					...
					A(FF,8D,8D,8D) A(FF,7B,7B,7B) A(FF,54,54,54) A(FF,88,88,88) A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) 
					...
					A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,CD,CD,CD) A(FF,A9,A9,A9) 
					A(FF,A9,A9,A9) A(FF,B7,B7,B7) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(FF,7F,7F,7F) A(FF,6F,6F,6F) A(FF,C4,C4,C4) A(FF,A0,A0,A0) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,01,34,8D) A(FF,00,00,80) 
					...
					A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(FF,FF,FF,FF) A(FF,69,69,69) A(FF,6C,6C,6C) A(FF,71,71,71) 
					A(FF,C3,C3,C3) A(FF,8D,8D,8D) A(FF,5D,5D,5D) A(FF,96,96,96) A(00,00,00,00) A(00,00,00,00) A(FF,01,34,8D) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) 
