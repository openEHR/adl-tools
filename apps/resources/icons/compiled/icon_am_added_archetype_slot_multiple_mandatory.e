...
class ICON_AM_ADDED_ARCHETYPE_SLOT_MULTIPLE_MANDATORY
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "am/added/archetype_slot.multiple_mandatory"
			...
			"{
				{
					...
					A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) 
					A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) 
					A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,EC,EC,EC) A(FF,FE,FE,FE) A(FF,B7,B7,B7) A(FF,6A,6A,6A) A(00,00,00,00) A(00,00,00,00) 
					A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) 
					A(FF,B7,B7,B7) A(FF,C2,C2,C2) A(FF,AC,AC,AC) A(FF,4B,4B,4B) A(FF,FF,FF,FF) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) 
					A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(FF,81,81,81) A(FF,9D,9D,9D) A(FF,7C,7C,7C) A(FF,7E,7E,7E) 
					...
					A(FF,AC,AC,AC) A(FF,BB,BB,BB) A(FF,00,00,80) A(FF,00,00,80) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,CC,CC,CC) A(FF,A5,A5,A5) 
