...
class ICON_AM_REDEFINED_C_ATTRIBUTE_OPTIONAL
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "am/redefined/c_attribute.optional"
			...
			"{
				{
					...
					A(FF,C0,C0,C0) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(00,00,00,00) A(00,00,00,00) 
					...
					A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(00,00,00,00) A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(FF,C0,C0,C0) 
					A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(FF,C0,C0,C0) A(00,00,00,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) 
					...
					A(00,00,00,00) A(00,00,00,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) 
					A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,C0,C0,C0) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,FF,FF,00) A(FF,FF,FF,00) 
					A(FF,FF,FF,00) A(FF,FF,FF,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) 
