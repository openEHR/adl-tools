...
class ICON_ARCHETYPE_TEMPLATE_VALID_ADHOC
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "archetype/template_valid_adhoc"
			...
			"{
				{
					...
					A(FF,28,93,1B) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,9D,E1,8D) A(FF,9D,E1,8D) A(FF,9D,E1,8D) A(FF,9D,E1,8D) A(FF,40,FF,13) 
					A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,40,FF,13) A(FF,40,FF,13) A(00,00,00,00) A(FF,28,93,1B) A(FF,29,96,1E) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,2A,9F,21) 
					...
					A(FF,28,93,1B) A(FF,29,96,1E) A(FF,28,99,1F) A(FF,FF,FF,00) A(FF,2A,9F,21) A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,9D,E1,8D) A(FF,FF,FF,FF) A(FF,FF,FF,FF) 
					...
					A(FF,40,FF,13) A(FF,FC,FE,FC) A(FF,28,99,1F) A(FF,29,9C,20) A(FF,2A,9F,21) A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,2E,A8,24) A(FF,2E,A9,25) A(FF,FF,FF,00) 
					...
					A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,2E,A8,24) A(FF,2E,A9,25) A(FF,2E,AE,26) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FC,FE,FC) A(FF,40,FF,13) A(FF,40,FF,13) 
