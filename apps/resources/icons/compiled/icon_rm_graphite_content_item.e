...
class ICON_RM_GRAPHITE_CONTENT_ITEM
			...
			"{
				{
					...
					A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,63,72,84) A(FF,41,6D,A1) A(FF,B0,C7,CF) A(FF,B2,C9,D2) A(FF,B2,C9,D2) A(FF,B2,C9,D2) A(FF,B2,C9,D2) 
					A(FF,B2,C9,D2) A(FF,67,9C,DB) A(FF,68,9D,DC) A(FF,4B,79,B0) A(FF,3A,48,5A) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,63,72,84) 
					A(FF,42,6E,A2) A(FF,AA,C0,C9) A(FF,AA,C0,C8) A(FF,AA,C0,C8) A(FF,AA,C0,C8) A(FF,AA,C0,C8) A(FF,AA,C0,C8) A(FF,56,8A,C8) A(FF,57,8B,C9) A(FF,49,76,AD) 
					...
					A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,63,72,84) A(FF,42,6E,A2) A(FF,AA,C0,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) 
					A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,80,A6,C9) A(FF,49,76,AD) A(FF,3A,48,5A) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,63,72,84) 
					A(FF,42,6E,A2) A(FF,AA,C0,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) A(FF,80,A6,C9) A(FF,49,76,AD) 
					A(FF,3A,48,5A) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,63,72,84) A(FF,42,6E,A2) A(FF,80,A5,C9) A(FF,AA,C1,C9) A(FF,AA,C1,C9) 
