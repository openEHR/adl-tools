...
class ICON_AM_ADDED_ARCHETYPE_SLOT_SINGLE_OPTIONAL
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "am/added/archetype_slot.single_optional"
			...
			"{
				{
					...
					A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) 
					A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) A(FF,01,34,8D) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(00,00,00,00) A(00,00,00,00) 
					A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(FF,EC,EC,EC) A(FF,FE,FE,FE) A(FF,B7,B7,B7) A(FF,6A,6A,6A) A(00,00,00,00) A(00,00,00,00) 
					A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(00,00,00,00) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,00,00,80) A(FF,01,34,8D) A(FF,81,81,81) A(FF,9D,9D,9D) A(FF,7C,7C,7C) A(FF,7E,7E,7E) 
					...
					A(FF,6B,6B,6B) A(FF,92,92,92) A(FF,B8,B8,B8) A(FF,B0,B0,B0) A(FF,00,00,80) A(FF,00,00,80) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) 
					...
					A(FF,78,78,78) A(00,00,00,00) A(00,00,00,00) A(00,00,00,00) A(FF,00,00,80) A(FF,01,34,8D) A(FF,FF,FF,FF) A(FF,9E,9E,9E) A(FF,FF,FF,FF) A(00,00,00,00) 
