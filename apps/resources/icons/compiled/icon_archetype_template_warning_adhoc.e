...
class ICON_ARCHETYPE_TEMPLATE_WARNING_ADHOC
...
feature {NONE} -- Initialization
	...
	make
			-- Initialization
		do
			key := "archetype/template_warning_adhoc"
			...
			"{
				{
					...
					A(FF,28,93,1B) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,E9,00) A(FF,C4,CB,00) A(FF,C4,CB,00) A(FF,FF,E9,00) A(FF,C4,CB,00) 
					A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,E9,00) A(FF,FF,E9,00) A(00,00,00,00) A(FF,28,93,1B) A(FF,29,96,1E) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,2A,9F,21) 
					...
					A(FF,28,93,1B) A(FF,29,96,1E) A(FF,28,99,1F) A(FF,FF,FF,00) A(FF,2A,9F,21) A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,FF,E9,00) A(FF,FF,FF,FF) A(FF,FF,FF,FF) 
					...
					A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,2E,A8,24) A(FF,FF,FF,00) A(FF,FF,E9,00) A(FF,FF,FF,FF) A(FF,FF,FF,FF) A(FF,FF,E9,00) A(FF,FF,E9,00) A(FF,FF,E9,00) 
					A(FF,FF,E9,00) A(FF,FF,FF,00) A(FF,28,99,1F) A(FF,29,9C,20) A(FF,2A,9F,21) A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,2E,A8,24) A(FF,2E,A9,25) A(FF,FF,FF,00) 
					...
					A(FF,2B,A2,22) A(FF,2D,A5,23) A(FF,2E,A8,24) A(FF,2E,A9,25) A(FF,2E,AE,26) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,FF,00) A(FF,FF,E9,00) A(FF,FF,E9,00) 
