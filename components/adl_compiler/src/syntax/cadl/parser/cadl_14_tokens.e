...
feature -- Token codes
	...
	ERR_VALUE_SET_MISSING_CODES: INTEGER = 272
	...
	SYM_ALLOW_ARCHETYPE: INTEGER = 308
	SYM_USE_NODE: INTEGER = 309
	SYM_INCLUDE: INTEGER = 310
	SYM_EXCLUDE: INTEGER = 311
	SYM_AFTER: INTEGER = 312
	SYM_BEFORE: INTEGER = 313
	SYM_CLOSED: INTEGER = 314
