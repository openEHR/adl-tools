...
feature -- Token codes
	...
	V_INTEGER: INTEGER is 259
	V_REAL: INTEGER is 260
	V_TYPE_IDENTIFIER: INTEGER is 261
	V_GENERIC_TYPE_IDENTIFIER: INTEGER is 262
	V_ATTRIBUTE_IDENTIFIER: INTEGER is 263
	V_FEATURE_CALL_IDENTIFIER: INTEGER is 264
	V_STRING: INTEGER is 265
	V_LOCAL_CODE: INTEGER is 266
	V_LOCAL_TERM_CODE_REF: INTEGER is 267
	V_QUALIFIED_TERM_CODE_REF: INTEGER is 268
	V_TERM_CODE_CONSTRAINT: INTEGER is 269
	V_REGEXP: INTEGER is 270
	V_ABS_PATH: INTEGER is 271
	V_REL_PATH: INTEGER is 272
	V_CHARACTER: INTEGER is 273
	V_URI: INTEGER is 274
	V_ISO8601_EXTENDED_DATE: INTEGER is 275
	V_ISO8601_EXTENDED_TIME: INTEGER is 276
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER is 277
	V_ISO8601_DURATION: INTEGER is 278
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER is 279
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER is 280
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER is 281
	V_ISO8601_DURATION_CONSTRAINT_PATTERN: INTEGER is 282
	V_C_DOMAIN_TYPE: INTEGER is 283
	SYM_START_CBLOCK: INTEGER is 284
	SYM_END_CBLOCK: INTEGER is 285
	SYM_ANY: INTEGER is 286
	SYM_INTERVAL_DELIM: INTEGER is 287
	SYM_TRUE: INTEGER is 288
	SYM_FALSE: INTEGER is 289
	SYM_THEN: INTEGER is 290
	SYM_ELSE: INTEGER is 291
	SYM_EXISTENCE: INTEGER is 292
	SYM_OCCURRENCES: INTEGER is 293
	SYM_CARDINALITY: INTEGER is 294
	SYM_UNORDERED: INTEGER is 295
	SYM_ORDERED: INTEGER is 296
	SYM_UNIQUE: INTEGER is 297
	SYM_ELLIPSIS: INTEGER is 298
	SYM_LIST_CONTINUE: INTEGER is 299
	SYM_MATCHES: INTEGER is 300
	SYM_USE_ARCHETYPE: INTEGER is 301
	SYM_ALLOW_ARCHETYPE: INTEGER is 302
	SYM_USE_NODE: INTEGER is 303
	SYM_INCLUDE: INTEGER is 304
	SYM_EXCLUDE: INTEGER is 305
	SYM_AFTER: INTEGER is 306
	SYM_BEFORE: INTEGER is 307
	SYM_CLOSED: INTEGER is 308
	ERR_CHARACTER: INTEGER is 309
	ERR_STRING: INTEGER is 310
	ERR_C_DOMAIN_TYPE: INTEGER is 311
	ERR_TERM_CODE_CONSTRAINT: INTEGER is 312
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER is 313
	ERR_V_ISO8601_DURATION: INTEGER is 314
	SYM_IMPLIES: INTEGER is 315
	SYM_OR: INTEGER is 316
	SYM_XOR: INTEGER is 317
	SYM_AND: INTEGER is 318
	SYM_EXISTS: INTEGER is 319
	SYM_FORALL: INTEGER is 320
	SYM_NOT: INTEGER is 321
	SYM_NE: INTEGER is 322
	SYM_LT: INTEGER is 323
	SYM_GT: INTEGER is 324
	SYM_LE: INTEGER is 325
	SYM_GE: INTEGER is 326
	SYM_DIV: INTEGER is 327
	SYM_MODULO: INTEGER is 328
	UNARY_MINUS: INTEGER is 329
