...
feature -- Token codes
	...
	SYM_START_CBLOCK: INTEGER = 285
	SYM_END_CBLOCK: INTEGER = 286
	SYM_ANY: INTEGER = 287
	SYM_INTERVAL_DELIM: INTEGER = 288
	SYM_TRUE: INTEGER = 289
	SYM_FALSE: INTEGER = 290
	SYM_THEN: INTEGER = 291
	SYM_ELSE: INTEGER = 292
	SYM_EXISTENCE: INTEGER = 293
	SYM_OCCURRENCES: INTEGER = 294
	SYM_CARDINALITY: INTEGER = 295
	SYM_UNORDERED: INTEGER = 296
	SYM_ORDERED: INTEGER = 297
	SYM_UNIQUE: INTEGER = 298
	SYM_ELLIPSIS: INTEGER = 299
	SYM_LIST_CONTINUE: INTEGER = 300
