...
feature -- Token codes
	...
	ERR_VALUE_SET_DEF_DUP_CODE: INTEGER = 275
	ERR_VALUE_SET_DEF: INTEGER = 276
	V_REGEXP: INTEGER = 277
	V_ABS_PATH: INTEGER = 278
	V_REL_PATH: INTEGER = 279
	V_CHARACTER: INTEGER = 280
	V_URI: INTEGER = 281
	V_ISO8601_EXTENDED_DATE: INTEGER = 282
	V_ISO8601_EXTENDED_TIME: INTEGER = 283
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER = 284
	V_ISO8601_DURATION: INTEGER = 285
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER = 286
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER = 287
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER = 288
	V_ISO8601_DURATION_CONSTRAINT_PATTERN: INTEGER = 289
	V_ISO8601_DURATION_CONSTRAINT_PATTERN_ERR: INTEGER = 290
