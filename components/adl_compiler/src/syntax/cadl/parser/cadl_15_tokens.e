...
feature -- Token codes
	...
	V_VALUE_SET_DEF: INTEGER = 271
	V_REGEXP: INTEGER = 272
	V_ABS_PATH: INTEGER = 273
	V_REL_PATH: INTEGER = 274
	V_CHARACTER: INTEGER = 275
	V_URI: INTEGER = 276
	V_ISO8601_EXTENDED_DATE: INTEGER = 277
	V_ISO8601_EXTENDED_TIME: INTEGER = 278
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER = 279
	V_ISO8601_DURATION: INTEGER = 280
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER = 281
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER = 282
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER = 283
	V_ISO8601_DURATION_CONSTRAINT_PATTERN: INTEGER = 284
	V_ISO8601_DURATION_CONSTRAINT_PATTERN_ERR: INTEGER = 285
	SYM_START_CBLOCK: INTEGER = 286
	SYM_END_CBLOCK: INTEGER = 287
	SYM_ANY: INTEGER = 288
	SYM_INTERVAL_DELIM: INTEGER = 289
	SYM_TRUE: INTEGER = 290
	SYM_FALSE: INTEGER = 291
	...
	SYM_LIST_CONTINUE: INTEGER = 301
	SYM_MATCHES: INTEGER = 302
	SYM_USE_ARCHETYPE: INTEGER = 303
	SYM_ALLOW_ARCHETYPE: INTEGER = 304
	SYM_USE_NODE: INTEGER = 305
	SYM_INCLUDE: INTEGER = 306
	SYM_EXCLUDE: INTEGER = 307
	SYM_AFTER: INTEGER = 308
	SYM_BEFORE: INTEGER = 309
	SYM_CLOSED: INTEGER = 310
	ERR_CHARACTER: INTEGER = 311
	ERR_STRING: INTEGER = 312
	ERR_VALUE_SET_DEF: INTEGER = 313
	ERR_V_ISO8601_DURATION: INTEGER = 314
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER = 315
