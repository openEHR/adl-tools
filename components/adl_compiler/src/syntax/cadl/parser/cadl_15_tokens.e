...
feature -- Token codes
	...
	ERR_VALUE_SET_DEF: INTEGER = 272
	V_REGEXP: INTEGER = 273
	V_ABS_PATH: INTEGER = 274
	V_REL_PATH: INTEGER = 275
	V_CHARACTER: INTEGER = 276
	V_URI: INTEGER = 277
	V_ISO8601_EXTENDED_DATE: INTEGER = 278
	V_ISO8601_EXTENDED_TIME: INTEGER = 279
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER = 280
	V_ISO8601_DURATION: INTEGER = 281
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER = 282
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER = 283
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER = 284
	V_ISO8601_DURATION_CONSTRAINT_PATTERN: INTEGER = 285
	V_ISO8601_DURATION_CONSTRAINT_PATTERN_ERR: INTEGER = 286
