...
feature -- Token codes
	...
	SYM_DESCRIPTION: INTEGER = 274
	SYM_ONTOLOGY: INTEGER = 275
	SYM_INVARIANT: INTEGER = 276
	SYM_ADL_VERSION: INTEGER = 277
	SYM_IS_CONTROLLED: INTEGER = 278
	SYM_IS_GENERATED: INTEGER = 279
