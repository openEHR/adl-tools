...
feature -- Token codes
	...
	SYM_TEMPLATE_COMPONENT: INTEGER = 267
	...
	SYM_DESCRIPTION: INTEGER = 273
	SYM_ONTOLOGY: INTEGER = 274
	SYM_INVARIANT: INTEGER = 275
	SYM_ADL_VERSION: INTEGER = 276
	SYM_IS_CONTROLLED: INTEGER = 277
	SYM_IS_GENERATED: INTEGER = 278
