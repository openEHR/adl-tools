...
feature -- Access
	...
	token_name (a_token: INTEGER): STRING
		...
		do
			...
			when SYM_RM_RELEASE then
				Result := "SYM_RM_RELEASE"
...
feature -- Token codes
	...
	SYM_COMPONENT_TERMINOLOGIES: INTEGER = 274
	SYM_DESCRIPTION: INTEGER = 275
	SYM_TERMINOLOGY: INTEGER = 276
	SYM_RULES: INTEGER = 277
