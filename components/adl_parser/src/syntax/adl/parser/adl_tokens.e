	...
	token_name (a_token: INTEGER): STRING is
		...
		do
			...
			when SYM_TEMPLATE then
				Result := "SYM_TEMPLATE"
			when SYM_TEMPLATE_COMPONENT then
				Result := "SYM_TEMPLATE_COMPONENT"
...
feature -- Token codes
	...
	SYM_TEMPLATE: INTEGER is 266
	SYM_TEMPLATE_COMPONENT: INTEGER is 267
	SYM_OPERATIONAL_TEMPLATE: INTEGER is 268
	SYM_CONCEPT: INTEGER is 269
	SYM_SPECIALIZE: INTEGER is 270
	SYM_DEFINITION: INTEGER is 271
	SYM_LANGUAGE: INTEGER is 272
	SYM_DESCRIPTION: INTEGER is 273
	SYM_ONTOLOGY: INTEGER is 274
	SYM_INVARIANT: INTEGER is 275
	SYM_ADL_VERSION: INTEGER is 276
	SYM_IS_CONTROLLED: INTEGER is 277
	SYM_IS_GENERATED: INTEGER is 278
