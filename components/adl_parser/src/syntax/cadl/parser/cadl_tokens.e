...
feature -- Token codes
	...
	V_CHARACTER: INTEGER is 271
	V_URI: INTEGER is 272
	V_ISO8601_EXTENDED_DATE: INTEGER is 273
	V_ISO8601_EXTENDED_TIME: INTEGER is 274
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER is 275
	V_ISO8601_DURATION: INTEGER is 276
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER is 277
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER is 278
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER is 279
	V_ISO8601_DURATION_CONSTRAINT_PATTERN: INTEGER is 280
	V_C_DOMAIN_TYPE: INTEGER is 281
	SYM_START_CBLOCK: INTEGER is 282
	SYM_END_CBLOCK: INTEGER is 283
	SYM_ANY: INTEGER is 284
	SYM_INTERVAL_DELIM: INTEGER is 285
	SYM_TRUE: INTEGER is 286
	SYM_FALSE: INTEGER is 287
	SYM_GE: INTEGER is 288
	SYM_LE: INTEGER is 289
	SYM_NE: INTEGER is 290
	SYM_EXISTS: INTEGER is 291
	SYM_FORALL: INTEGER is 292
	SYM_THEN: INTEGER is 293
	SYM_ELSE: INTEGER is 294
	SYM_EXISTENCE: INTEGER is 295
	SYM_OCCURRENCES: INTEGER is 296
	SYM_CARDINALITY: INTEGER is 297
	SYM_UNORDERED: INTEGER is 298
	SYM_ORDERED: INTEGER is 299
	SYM_UNIQUE: INTEGER is 300
	SYM_ELLIPSIS: INTEGER is 301
	SYM_INFINITY: INTEGER is 302
	SYM_LIST_CONTINUE: INTEGER is 303
	SYM_INVARIANT: INTEGER is 304
	SYM_MATCHES: INTEGER is 305
	SYM_USE_ARCHETYPE: INTEGER is 306
	SYM_ALLOW_ARCHETYPE: INTEGER is 307
	SYM_USE_NODE: INTEGER is 308
	SYM_INCLUDE: INTEGER is 309
	SYM_EXCLUDE: INTEGER is 310
	SYM_AFTER: INTEGER is 311
	SYM_BEFORE: INTEGER is 312
	SYM_CLOSED: INTEGER is 313
	SYM_DT_UNKNOWN: INTEGER is 314
	ERR_CHARACTER: INTEGER is 315
	ERR_STRING: INTEGER is 316
	ERR_C_DOMAIN_TYPE: INTEGER is 317
	ERR_TERM_CODE_CONSTRAINT: INTEGER is 318
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER is 319
	ERR_V_ISO8601_DURATION: INTEGER is 320
	SYM_IMPLIES: INTEGER is 321
	SYM_OR: INTEGER is 322
	SYM_XOR: INTEGER is 323
	SYM_AND: INTEGER is 324
	SYM_LT: INTEGER is 325
	SYM_GT: INTEGER is 326
	SYM_DIV: INTEGER is 327
	SYM_MODULO: INTEGER is 328
	SYM_NOT: INTEGER is 329
