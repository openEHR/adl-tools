...
feature -- Token codes
	...
	V_ISO8601_DURATION: INTEGER is 264
	...
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER is 272
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER is 273
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER is 274
	V_C_DOMAIN_TYPE: INTEGER is 275
	SYM_START_CBLOCK: INTEGER is 276
	SYM_END_CBLOCK: INTEGER is 277
	SYM_ANY: INTEGER is 278
	SYM_INTERVAL_DELIM: INTEGER is 279
	SYM_TRUE: INTEGER is 280
	SYM_FALSE: INTEGER is 281
	SYM_GE: INTEGER is 282
	SYM_LE: INTEGER is 283
	SYM_NE: INTEGER is 284
	SYM_EXISTS: INTEGER is 285
	SYM_FORALL: INTEGER is 286
	SYM_THEN: INTEGER is 287
	SYM_ELSE: INTEGER is 288
	SYM_EXISTENCE: INTEGER is 289
	SYM_OCCURRENCES: INTEGER is 290
	SYM_CARDINALITY: INTEGER is 291
	SYM_UNORDERED: INTEGER is 292
	SYM_ORDERED: INTEGER is 293
	SYM_UNIQUE: INTEGER is 294
	SYM_ELLIPSIS: INTEGER is 295
	SYM_INFINITY: INTEGER is 296
	SYM_LIST_CONTINUE: INTEGER is 297
	SYM_INVARIANT: INTEGER is 298
	SYM_MATCHES: INTEGER is 299
	SYM_ALLOW_ARCHETYPE: INTEGER is 300
	SYM_USE_NODE: INTEGER is 301
	SYM_INCLUDE: INTEGER is 302
	SYM_EXCLUDE: INTEGER is 303
	SYM_DT_UNKNOWN: INTEGER is 304
	ERR_CHARACTER: INTEGER is 305
	ERR_STRING: INTEGER is 306
	ERR_C_DOMAIN_TYPE: INTEGER is 307
	ERR_TERM_CODE_CONSTRAINT: INTEGER is 308
	SYM_IMPLIES: INTEGER is 309
	SYM_OR: INTEGER is 310
	SYM_XOR: INTEGER is 311
	SYM_AND: INTEGER is 312
	SYM_LT: INTEGER is 313
	SYM_GT: INTEGER is 314
	SYM_DIV: INTEGER is 315
	SYM_MODULO: INTEGER is 316
	SYM_NOT: INTEGER is 317
