...
feature -- Token codes
	...
	V_FEATURE_CALL_IDENTIFIER: INTEGER is 262
	V_STRING: INTEGER is 263
	V_LOCAL_CODE: INTEGER is 264
	V_LOCAL_TERM_CODE_REF: INTEGER is 265
	V_QUALIFIED_TERM_CODE_REF: INTEGER is 266
	V_TERM_CODE_CONSTRAINT: INTEGER is 267
	V_REGEXP: INTEGER is 268
	V_CHARACTER: INTEGER is 269
	V_URI: INTEGER is 270
	V_ISO8601_EXTENDED_DATE: INTEGER is 271
	V_ISO8601_EXTENDED_TIME: INTEGER is 272
	V_ISO8601_EXTENDED_DATE_TIME: INTEGER is 273
	V_ISO8601_DURATION: INTEGER is 274
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER is 275
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER is 276
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER is 277
	V_ISO8601_DURATION_CONSTRAINT_PATTERN: INTEGER is 278
	V_C_DOMAIN_TYPE: INTEGER is 279
	SYM_START_CBLOCK: INTEGER is 280
	SYM_END_CBLOCK: INTEGER is 281
	SYM_ANY: INTEGER is 282
	SYM_INTERVAL_DELIM: INTEGER is 283
	SYM_TRUE: INTEGER is 284
	SYM_FALSE: INTEGER is 285
	SYM_GE: INTEGER is 286
	SYM_LE: INTEGER is 287
	SYM_NE: INTEGER is 288
	SYM_EXISTS: INTEGER is 289
	SYM_FORALL: INTEGER is 290
	SYM_THEN: INTEGER is 291
	SYM_ELSE: INTEGER is 292
	SYM_EXISTENCE: INTEGER is 293
	SYM_OCCURRENCES: INTEGER is 294
	SYM_CARDINALITY: INTEGER is 295
	SYM_UNORDERED: INTEGER is 296
	SYM_ORDERED: INTEGER is 297
	SYM_UNIQUE: INTEGER is 298
	SYM_ELLIPSIS: INTEGER is 299
	SYM_INFINITY: INTEGER is 300
	SYM_LIST_CONTINUE: INTEGER is 301
	SYM_INVARIANT: INTEGER is 302
	SYM_MATCHES: INTEGER is 303
	SYM_ALLOW_ARCHETYPE: INTEGER is 304
	SYM_USE_NODE: INTEGER is 305
	SYM_INCLUDE: INTEGER is 306
	SYM_EXCLUDE: INTEGER is 307
	SYM_DT_UNKNOWN: INTEGER is 308
	...
	SYM_LT: INTEGER is 319
	SYM_GT: INTEGER is 320
	SYM_DIV: INTEGER is 321
	SYM_MODULO: INTEGER is 322
	SYM_NOT: INTEGER is 323
