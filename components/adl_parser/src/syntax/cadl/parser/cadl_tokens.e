...
feature -- Token codes
	...
	SYM_INVARIANT: INTEGER = 300
	SYM_MATCHES: INTEGER = 301
	SYM_USE_ARCHETYPE: INTEGER = 302
	SYM_ALLOW_ARCHETYPE: INTEGER = 303
	SYM_USE_NODE: INTEGER = 304
	SYM_INCLUDE: INTEGER = 305
	SYM_EXCLUDE: INTEGER = 306
	SYM_AFTER: INTEGER = 307
	SYM_BEFORE: INTEGER = 308
	SYM_CLOSED: INTEGER = 309
	ERR_CHARACTER: INTEGER = 310
	ERR_STRING: INTEGER = 311
	ERR_C_DOMAIN_TYPE: INTEGER = 312
	ERR_TERM_CODE_CONSTRAINT: INTEGER = 313
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER = 314
	ERR_V_ISO8601_DURATION: INTEGER = 315
