...
feature -- Token codes
	...
	V_ISO8601_DATE_TIME_CONSTRAINT_PATTERN: INTEGER is 271
	V_ISO8601_TIME_CONSTRAINT_PATTERN: INTEGER is 272
	V_ISO8601_DATE_CONSTRAINT_PATTERN: INTEGER is 273
	V_C_DOMAIN_TYPE: INTEGER is 274
	SYM_START_CBLOCK: INTEGER is 275
	SYM_END_CBLOCK: INTEGER is 276
	SYM_ANY: INTEGER is 277
	SYM_INTERVAL_DELIM: INTEGER is 278
	SYM_TRUE: INTEGER is 279
	SYM_FALSE: INTEGER is 280
	SYM_GE: INTEGER is 281
	SYM_LE: INTEGER is 282
	SYM_NE: INTEGER is 283
	SYM_AND: INTEGER is 284
	SYM_OR: INTEGER is 285
	SYM_NOT: INTEGER is 286
	SYM_XOR: INTEGER is 287
	SYM_IMPLIES: INTEGER is 288
	...
	SYM_LT: INTEGER is 313
	SYM_GT: INTEGER is 314
	SYM_DIV: INTEGER is 315
	SYM_MODULO: INTEGER is 316
