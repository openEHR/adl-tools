...
feature -- Token codes
	...
	SYM_DT_UNKNOWN: INTEGER is 313
	ERR_CHARACTER: INTEGER is 314
	ERR_STRING: INTEGER is 315
	ERR_C_DOMAIN_TYPE: INTEGER is 316
	ERR_TERM_CODE_CONSTRAINT: INTEGER is 317
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER is 318
	ERR_V_ISO8601_DURATION: INTEGER is 319
	SYM_IMPLIES: INTEGER is 320
	SYM_OR: INTEGER is 321
	SYM_XOR: INTEGER is 322
	SYM_AND: INTEGER is 323
	SYM_LT: INTEGER is 324
	SYM_GT: INTEGER is 325
	SYM_DIV: INTEGER is 326
	SYM_MODULO: INTEGER is 327
	SYM_NOT: INTEGER is 328
