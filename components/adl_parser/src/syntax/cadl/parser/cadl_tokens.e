...
feature -- Token codes
	...
	SYM_AFTER: INTEGER is 309
	SYM_BEFORE: INTEGER is 310
	SYM_DT_UNKNOWN: INTEGER is 311
	ERR_CHARACTER: INTEGER is 312
	ERR_STRING: INTEGER is 313
	ERR_C_DOMAIN_TYPE: INTEGER is 314
	ERR_TERM_CODE_CONSTRAINT: INTEGER is 315
	ERR_V_QUALIFIED_TERM_CODE_REF: INTEGER is 316
	ERR_V_ISO8601_DURATION: INTEGER is 317
	SYM_IMPLIES: INTEGER is 318
	SYM_OR: INTEGER is 319
	SYM_XOR: INTEGER is 320
	SYM_AND: INTEGER is 321
	SYM_LT: INTEGER is 322
	SYM_GT: INTEGER is 323
	SYM_DIV: INTEGER is 324
	SYM_MODULO: INTEGER is 325
	SYM_NOT: INTEGER is 326
