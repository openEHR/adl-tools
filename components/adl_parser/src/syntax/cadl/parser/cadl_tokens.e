...
feature -- Token codes
	...
	V_C_DOMAIN_TYPE: INTEGER is 278
	SYM_START_CBLOCK: INTEGER is 279
	SYM_END_CBLOCK: INTEGER is 280
	SYM_ANY: INTEGER is 281
	SYM_INTERVAL_DELIM: INTEGER is 282
	SYM_TRUE: INTEGER is 283
	SYM_FALSE: INTEGER is 284
	SYM_GE: INTEGER is 285
	SYM_LE: INTEGER is 286
	SYM_NE: INTEGER is 287
	SYM_EXISTS: INTEGER is 288
	SYM_FORALL: INTEGER is 289
	...
	SYM_INFINITY: INTEGER is 299
	SYM_LIST_CONTINUE: INTEGER is 300
	SYM_INVARIANT: INTEGER is 301
	SYM_MATCHES: INTEGER is 302
	SYM_ALLOW_ARCHETYPE: INTEGER is 303
	SYM_USE_NODE: INTEGER is 304
	SYM_INCLUDE: INTEGER is 305
	SYM_EXCLUDE: INTEGER is 306
	SYM_DT_UNKNOWN: INTEGER is 307
	ERR_CHARACTER: INTEGER is 308
	ERR_STRING: INTEGER is 309
	ERR_C_DOMAIN_TYPE: INTEGER is 310
	ERR_TERM_CODE_CONSTRAINT: INTEGER is 311
	SYM_IMPLIES: INTEGER is 312
	SYM_OR: INTEGER is 313
	SYM_XOR: INTEGER is 314
	SYM_AND: INTEGER is 315
	SYM_LT: INTEGER is 316
	SYM_GT: INTEGER is 317
	SYM_DIV: INTEGER is 318
	SYM_MODULO: INTEGER is 319
	SYM_NOT: INTEGER is 320
