...
feature {NONE} -- Initialisation
	...
	make_legacy (a_path: STRING; a_repository: ARCHETYPE_REPOSITORY_I; arch_thumbnail: ARCHETYPE_THUMBNAIL)
		...
		do
			...
			differential_invalid_path := extension_replaced (a_path, File_ext_archetype_adl_diff)
...
feature -- Access (semantic)
	...
	differential_invalid_path: detachable STRING
...
feature -- File Operations
	...
	save_invalid_differential
		...
		do
			if attached differential_archetype as da and attached differential_invalid_path as diff_path then
				file_repository.save_text_to_file (diff_path, adl15_engine.serialise (da, Syntax_type_adl, da.original_language.code_string))
			end
		end
