...
feature -- Access (semantic)
	...
	invalid_differential_path: detachable STRING
			-- Path of differential source file of invalid archetype, generated by legacy diff process
			-- never read, useful for debugging diff algoritm
	...
	invalid_differential_text: detachable STRING
			-- provide invalid differential text if it is available
		require
			invalid_differential_file_available: has_invalid_differential_file
		do
			if attached invalid_differential_path as inv_diff_path then
				file_repository.read_text_from_file (inv_diff_path)
				check attached file_repository.text as t then
					Result := t
				end
			end
...
feature -- Status Report - Semantic
	...
	has_invalid_differential_file: BOOLEAN
			-- Does the repository have a saved incompletely source-form file for this archetype?
		do
			Result := attached invalid_differential_path as inv_diff_path and then file_repository.is_valid_path (inv_diff_path)
		end
...
feature -- File Operations
	...
	save_invalid_differential
			-- Save differential archetype created by diff with legacy parent, which doesn't validate. This archetype
