		...
		do
			...
			across bmm_models_access.bmm_models as models_csr loop
				...
				if aom_profiles_access.has_profile_for_rm_schema (bm.model_id) then
					...
					archetype_parent_class := if not aom_profile.archetype_parent_class.is_empty then aom_profile.archetype_parent_class else Any_type_name end
				else
					archetype_parent_class := Any_type_name
				end
